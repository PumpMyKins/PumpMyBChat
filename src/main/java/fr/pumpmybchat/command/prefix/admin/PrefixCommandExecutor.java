...
import fr.pumpmybchat.command.prefix.ISubTabCompleter;
import fr.pumpmybchat.command.prefix.SubCommandData;
...
public class PrefixCommandExecutor extends Command implements TabExecutor{
	...
	public void execute(CommandSender sender, String[] args) {
		...
		if( args.length < 1 ) {
			...
			new HelpPrefixAdminSubCommand().onSubCommand(this, sender);
			return;
