...
public class ChatManager implements Listener {
	...
	private void initMySql() throws Exception {
		String createtable = "CREATE TABLE IF NOT EXISTS `prefixplayer` ( `uuid` VARCHAR(50) NOT NULL , `prefix` VARCHAR(50) NOT NULL DEFAULT 'I-LOVE-PMK' , `active` BOOLEAN NOT NULL DEFAULT '1' , `modification` INT NOT NULL , PRIMARY KEY (`uuid`), UNIQUE (`uuid`)) ENGINE = InnoDB;";
